...
class FoxgloveBroadcaster:
    ...
    def start(self):
        ...
        try:
            ...
            self._node_channel = foxglove.Channel(
                "/node_update", message_encoding="json", schema={"type": "object", "title": "NodeUpdate"}
            )
            self._status_channel = foxglove.Channel(
                "/system_status", message_encoding="json", schema={"type": "object", "title": "SystemStatus"}
            )
            self._clusters_channel = foxglove.Channel(
                "/clusters", message_encoding="json", schema={"type": "object", "title": "Clusters"}
            )
            self._gps_channel = _fg_channels.LocationFixChannel("/gps")
            self.running = True
            logger.info(f"Foxglove server started on port {self.port}")
        except Exception as e:
            logger.error(f"Foxglove server start failed: {e}")
            self.running = False
    ...
    def stop(self):
        ...
        try:
            ...
            logger.error(f"Foxglove server stop error: {e}")
    ...
    def publish_node_update(self, data: dict):
        ...
        try:
            ...
            logger.error(f"Foxglove publish_node_update error: {e}")
    ...
    def publish_node_location(self, node_id, lat, lon, alt):
        ...
        try:
            ...
            logger.error(f"Foxglove publish_node_location error: {e}")
    ...
    def publish_system_status(self, data: dict):
        ...
        try:
            ...
            logger.error(f"Foxglove publish_system_status error: {e}")
    ...
    def publish_clusters(self, data: dict):
        ...
        try:
            ...
            logger.error(f"Foxglove publish_clusters error: {e}")
    ...
    def publish_scene(self, cluster_id, tracks, hot_voxels, rays):
        ...
        try:
            ...
            logger.error(f"Foxglove publish_scene error: {e}")
