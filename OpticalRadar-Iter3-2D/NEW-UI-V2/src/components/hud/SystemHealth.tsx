...
export function SystemHealth({ status }: SystemHealthProps) {
    ...
    return (
        <div className="bg-black/50 border border-green-500/40 p-3 rounded-xl backdrop-blur-md pointer-events-auto shadow-[0_0_20px_rgba(0,255,0,0.15)] transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,255,0,0.25)]">
