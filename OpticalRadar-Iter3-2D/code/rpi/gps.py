...
class GPSReader:
    ...
    def _read_loop(self) -> None:
        ...
        while self._running:
            try:
                ...
                # Log but continue — transient serial errors are common
    ...
    def _parse_nmea(self, sentence: str) -> None:
        ...
        try:
            ...
            # Malformed sentence — skip silently but could log at debug level
            pass  # Common for partial sentences; upgrade to logging if needed
